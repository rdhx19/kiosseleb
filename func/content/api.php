									...
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tbody>
												<tr>
													<td>URL</td>
													<td><?php echo $config['url_web']; ?>api/api.php</td>
												</tr>
												<tr>
													<td>key</td>
													<td>Your API key</td>
												...
												<tr>
													<td>service</td>
													<td>Service ID <a href="<?php echo $config['url_web']; ?>?<?php echo paramEncrypt('content=harga')?>">Check at price list</a></td>
												</tr>
												<tr>
													<td>target</td>
												...
												<tr>
													...
													<td><a href="<?php echo $config['url_web']; ?>api/api_order.txt" target="blank">Example</a></td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr>
													<td>Example PHP Code</td>
													<td><a href="<?php echo $config['url_web']; ?>api/api_status.txt" target="blank">Example</a></td>
												</tr>
											</tbody>
										</table>
									</div>
...

{
	...
	"data" = {
		"sid" = "1"
		"category" = "IGF"
		"service" = "Instagram Followers 1"
		"price" = "10000"
		"min" = "100"
		"max" = "1000"
		"status" = "Active"
		"note" = "Fast - Real - Instant"
	}
}

...
if (isset($_POST['category'])) {
	...
	$check_service = $tur->query("SELECT * FROM services1 WHERE category = '$post_cat' AND status = 'Active' ORDER BY sid ASC");
	?>
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover m-0">
												...
												<tbody>
												<?php
												$check_service = $tur->query("SELECT * FROM services1 WHERE category = '$post_cat' AND status = 'Active'");
